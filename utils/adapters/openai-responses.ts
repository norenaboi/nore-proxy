...
function buildResponsesBody(openaiReq: any, actualModel: any, isStream: any) {
...
function convertUserContent(content: any) {
 ...
 */
function responsesErrorStatus(code: any) {
  switch (code) {
 ...
 */
function toolCallIndex(ctx: any, outputIndex: any) {
...
function mapFinishReason(response: any, hasToolCalls: any) {
  if (
...
function responsesUsageToOpenAI(usage: any) {
