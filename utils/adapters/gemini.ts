 ...
 */
function contentToParts(content: any) {
 ...
 */
export function transformRequest(openaiReq: any) {
...
function buildGeminiBody(openaiReq: any) {
 ...
 */
function extractGeminiToolCalls(data: any) {
  const candidate = data?.candidates?.[0];
 ...
 */
function geminiUsageToOpenAI(meta: any) {
  if (!meta) return null;
