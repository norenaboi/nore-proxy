 ...
 */
function resolveRequestId(ctx: any) {
 ...
 */
function resolveCacheKey(openaiReq: any, requestId: any) {
  const supplied =
...
function decorate(body: any, openaiReq: any, ctx: any) {
 ...
 * (non-streaming).
 */
export function transformRequest(openaiReq: any, actualModel: any, ctx: any) {
 ...
 * Codex fields.
 */
export function transformStreamRequest(openaiReq: any, actualModel: any, ctx: any) {
 ...
 */
export function getExtraHeaders(ctx: { requestId?: string; isStreaming?: boolean } = {}) {
  const requestId = resolveRequestId(ctx);
